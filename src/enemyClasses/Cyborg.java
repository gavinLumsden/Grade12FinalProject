...
public class Cyborg extends Enemy {
    ...
    public Cyborg(JLabel image, int amount, int direction, int numberOfDirections, int delay, int level) throws MalformedURLException {
        ...
        sprite.setImage(Icons.CYBORG_IDLE_DOWN);
        sprite.debug("");
        sprite.removeBorder();
    }
