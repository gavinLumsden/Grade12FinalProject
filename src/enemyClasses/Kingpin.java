...
public class Kingpin extends Enemy {
    ...
    public Kingpin(JLabel image, int amount, int direction, int numberOfDirections, int delay, int level) {
        ...
        sprite.setImage("/animations/enemyclasses/kingpin/kingpinRightIdle.png");
        sprite.debug("");
        sprite.removeBorder();
    }
