...
public class Kingpin extends Enemy {
    ...
    public Kingpin(JLabel image, int amount, int direction, int numberOfDirections, int delay, int level) throws MalformedURLException {
        ...
        sprite.setImage(Icons.KINGPIN_IDLE_DOWN);
        sprite.debug("");
        sprite.removeBorder();
    }
