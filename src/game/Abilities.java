    ...
    public Abilities(String selected) {
        if (selected.equals("vampire")) {
            ...
            JOptionPane.showMessageDialog(null, "Class: Juggernaut\n\n"
                    ...
                    + "Ablilty 3: Hold, next punch cannnot be dodged, does x1.5 damage\n"
        ...
        } else if (selected.equals("engineer")) {
            JOptionPane.showMessageDialog(null, "Class: Engineer\n\n"
                    + "Ability 1: Trump, builds a wall (increases defence by 1)\n"
                    + "Ability 2: Repair, heals 10% of health\n"
                    + "Ablilty 3: Flashbang, stuns the enemy for _ seconds\n"
                    + "Ability 4: My baby, builds a turret that does x_ damage (based on your damage stat), \n"
                    + "lasts for _ seconds\n"
                    + "Passive: German engineering, heal 25% of your health after a battle\n"
                    + "Ultimate: Turbo, Speed increases by _ for _ seconds");
        ...
        } else if (selected.equals("bandit")) {
            ...
            JOptionPane.showMessageDialog(null, "Class: Mage\n\n"
                    ...
                    + "Passive: \n"
                    + "Ultimate: ");
        } else if (selected.equals("trickster")) {
            JOptionPane.showMessageDialog(null, "Class: Trickster\n\n"
                    + "Ability 1: \n"
                    + "Ability 2: \n"
                    + "Ablilty 3: \n"
                    + "Ability 4: \n"
                    + "Passive: \n"
                    + "Ultimate: ");
        } else if (selected.equals("hammer")) {
            JOptionPane.showMessageDialog(null, "Class: Hammer\n\n"
                    + "Ability 1: \n"
                    + "Ability 2: \n"
                    + "Ablilty 3: \n"
                    + "Ability 4: \n"
                    + "Passive: \n"
                    + "Ultimate: ");
        } else if (selected.equals("mimic")) {
            JOptionPane.showMessageDialog(null, "Class: Mimic\n\n"
                    + "Ability 1: \n"
                    + "Ability 2: \n"
                    + "Ablilty 3: \n"
                    + "Ability 4: \n"
