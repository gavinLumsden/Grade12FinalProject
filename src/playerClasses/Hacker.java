...
public class Hacker extends GameCharacter {
    ...
    public String attack2    = "Crash";
    public String attack3    = "Copy";
    public String attack4    = "Virus";
    ...
    /**
     * Constructor for the hacker player class (when loading a hero)
     * @param locations
     * @param grid
     * @param heroImage
     * @param engine
     */
    public Hacker(Location[][] locations, Grid grid, JLabel heroImage, GameEngine engine) {
     ...
     * @param data 
     */
    public Hacker(Location[][] locations, Grid grid, JLabel heroImage, GameEngine engine, String[] data) {
        super(heroImage, 100, Directions.STOP, Directions.FOUR_DIRECTIONS, 100);
