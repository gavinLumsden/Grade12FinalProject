...
public class Juggernaut extends GameCharacter {
    ...
    /**
     * Constructor for the juggernaut player class (when loading a hero)
     * @param locations
     * @param grid
     * @param heroImage
     * @param engine
     */
    public Juggernaut(Location[][] locations, Grid grid, JLabel heroImage, GameEngine engine) {
     ...
     * @param data 
     */
    public Juggernaut(Location[][] locations, Grid grid, JLabel heroImage, GameEngine engine, String[] data) {
        super(heroImage, 100, Directions.STOP, Directions.FOUR_DIRECTIONS, 100);
